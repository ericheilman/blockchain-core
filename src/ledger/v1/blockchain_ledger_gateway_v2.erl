...
-spec get_split(Gateway :: gateway(), OwnerAddress :: libp2p_crypto:pubkey_bin()) -> undefined | non_neg_integer().
...
deserialize(<<2, Bin/binary>>) ->
  ...
  RewardsMap = lists:foldl(
        fun(Reward, Acc) ->
                ...
                maps:put(OwnerAddress, RewardsMap2, Acc)
